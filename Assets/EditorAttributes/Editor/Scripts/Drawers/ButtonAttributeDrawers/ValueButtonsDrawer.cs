...
namespace EditorAttributes.Editor {
    ...
    public class ValueButtonsDrawer : PropertyDrawerBase {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            var displayNames =
                ConvertCollectionValuesToStrings(selectionButtonsAttribute.CollectionName, property, memberInfo,
                    errorBox).ToArray();
        ...
        private VisualElement DrawButtons(int buttonsValue, string[] valueLabels,
            ...
            var buttonGroup =
                new ToggleButtonGroup(selectionButtonsAttribute.ShowLabel ? preferredLabel : string.Empty);

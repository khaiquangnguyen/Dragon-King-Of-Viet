...
namespace EditorAttributes.Editor {
    ...
    public class InlineButtonDrawer : PropertyDrawerBase {
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            var methodInfo = ReflectionUtility.FindFunction(inlineButtonAttribute.FunctionName,
            ...
            if (inlineButtonAttribute.IsRepetable) {
                var repeatButton =
                    new RepeatButton(() => methodInfo.Invoke(property.serializedObject.targetObject, null),
                            inlineButtonAttribute.PressDelay, inlineButtonAttribute.RepetitionInterval)
                        { text = buttonLabel };
                ...
                var button = new Button(() => methodInfo.Invoke(property.serializedObject.targetObject, null))
                    { text = buttonLabel };

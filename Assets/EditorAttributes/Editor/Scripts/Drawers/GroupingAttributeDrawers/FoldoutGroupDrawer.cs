        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            foreach (string variableName in foldoutGroup.FieldsToGroup) {
                ...
                if (variableProperty != null) {
                    ...
                    if (variableProperty.propertyType ==
                        SerializedPropertyType.Generic) // Slightly move dropdowns for serialized objects
                        propertyField.style.marginLeft = 10f;

                    propertyField.style.unityFontStyleAndWeight = FontStyle.Normal;
                    propertyField.schedule
                        .Execute(() => propertyField.Q<Label>().style.marginRight = foldoutGroup.WidthOffset)
                        .ExecuteLater(30);

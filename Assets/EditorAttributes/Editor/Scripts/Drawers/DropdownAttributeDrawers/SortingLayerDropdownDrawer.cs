        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            if (property.propertyType == SerializedPropertyType.Integer) {
                ...
                root.schedule.Execute(() =>
                    maskField.Q(className: "unity-base-popup-field__input").style.backgroundColor =
                ...
                root.Add(new HelpBox("The SortingLayerDropdown attribute can only be attached to int fields",

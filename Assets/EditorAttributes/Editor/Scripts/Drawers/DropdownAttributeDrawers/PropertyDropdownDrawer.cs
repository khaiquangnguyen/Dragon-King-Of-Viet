...
namespace EditorAttributes.Editor {
    ...
    public class PropertyDropdownDrawer : PropertyDrawerBase {
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            var errorBox =
                new HelpBox(
                    "The PropertyDropdown Attribute can only be attached to objects deriving from Component or ScriptableObject",
        ...
        private void InitializeFoldoutDrawer(VisualElement root, SerializedProperty property, Type fieldType,
            HelpBox errorBox) {
        ...
        private Foldout CreatePropertyFoldout(SerializedObject serializedObject, SerializedProperty serilizedProperty) {
            var isFoldedSaveKey =
                $"{serilizedProperty.serializedObject.targetObject}_{serilizedProperty.propertyPath}_IsFolded";
                ...
                if (property.NextVisible(true)) {
                    do {
                        if (property.name.Equals("m_Script",
                                StringComparison.Ordinal)) // Exclude the field containing the script reference
                            continue;

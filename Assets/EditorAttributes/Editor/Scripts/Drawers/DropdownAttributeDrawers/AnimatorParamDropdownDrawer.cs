    ...
    public class AnimatorParamDropdownDrawer : PropertyDrawerBase {
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            if (property.propertyType == SerializedPropertyType.String) {
                ...
                var dropdownField = IsCollectionValid(animatorParameters)
                    ? new DropdownField(property.displayName, animatorParameters,
                        GetDropdownDefaultValue(animatorParameters, property))
                    : new DropdownField(property.displayName, new List<string>() { "NULL" }, 0);

                root.schedule.Execute(() =>
                    dropdownField.Q(className: "unity-base-popup-field__input").style.backgroundColor =
                        EditorExtension.GLOBAL_COLOR / 2f).ExecuteLater(1);
        ...
        private List<string> GetAnimatorParams(AnimatorParamDropdownAttribute animatorParamAttribute,
            ...
            if (memberInfoType == typeof(Animator)) {
                ...
                if (memberInfoValue != null && memberInfoValue.runtimeAnimatorController != null) {
                    ...
                    var editorController =
                        AssetDatabase.LoadAssetAtPath<AnimatorController>(
                            AssetDatabase.GetAssetPath(memberInfoValue.runtimeAnimatorController));
                ...
                errorBox.text =
                    $"The provided field \"{animatorParamAttribute.AnimatorFieldName}\" is not of type Animator";
                return null;
            }

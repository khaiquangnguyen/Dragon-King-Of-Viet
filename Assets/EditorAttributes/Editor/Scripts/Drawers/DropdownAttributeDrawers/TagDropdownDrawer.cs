    ...
    public class TagDropdownDrawer : PropertyDrawerBase {
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            if (property.propertyType == SerializedPropertyType.String) {
                var tagField =
                    new TagField(property.displayName,
                ...
                root.schedule.Execute(() =>
                    tagField.Q(className: "unity-base-popup-field__input").style.backgroundColor =
                ...
                root.Add(new HelpBox("The TagDropdown attribute can only be attached to string fields",

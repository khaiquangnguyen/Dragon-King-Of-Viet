...
namespace EditorAttributes.Editor {
    public class PropertyDrawerBase : PropertyDrawer {
        ...
        protected static void
            SetProperyValueFromString(string value, ref SerializedProperty property, HelpBox errorBox) {
            try {
        ...
        protected static List<string> ConvertCollectionValuesToStrings(string collectionName,
            SerializedProperty serializedProperty, MemberInfo memberInfo, HelpBox errorBox) {
        ...
        protected void UpdateVisualElement(VisualElement visualElement, Action logicToUpdate) => visualElement.schedule
            .Execute(() => EditorExtension.AddToUpdateLoop(logicToUpdate)).ExecuteLater(1);
        ...
        public static void UpdateVisualElementAtInterval(VisualElement visualElement, Action logicToUpdate,
            long intervalMs = 60) => visualElement.schedule.Execute(logicToUpdate).Every(intervalMs);
        ...
        public static bool GetConditionValue(MemberInfo memberInfo, IConditionalAttribute conditionalAttribute,
            ...
            errorBox.text =
                $"The provided condition \"{conditionalAttribute.ConditionName}\" is not a valid boolean or an enum";
            ...
            object targetObject, HelpBox errorBox) // Internal function used for the button drawer
        {
            ...
            if (memberInfoType == typeof(bool)) {
                ...
                return (int)ReflectionUtility.GetMemberInfoValue(memberInfo, targetObject) ==

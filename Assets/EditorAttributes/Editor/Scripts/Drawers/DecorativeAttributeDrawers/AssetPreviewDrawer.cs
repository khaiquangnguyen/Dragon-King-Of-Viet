            ...
            if (property.propertyType == SerializedPropertyType.ObjectReference) {
                ...
                UpdateVisualElement(root, () => {
                    try {
                        ...
                        var imageWidth = assetPreviewAttribute.PreviewWidth == 0f
                            ? GetTextureSize(texture).x
                            : assetPreviewAttribute.PreviewWidth;
                        var imageHeight = assetPreviewAttribute.PreviewHeight == 0f
                            ? GetTextureSize(texture).y
                            : assetPreviewAttribute.PreviewHeight;

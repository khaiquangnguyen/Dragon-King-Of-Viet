...
namespace EditorAttributes.Editor {
    ...
    public class WrapDrawer : PropertyDrawerBase {
            ...
            root.RegisterCallback<SerializedPropertyChangeEvent>((e) => {
                switch (property.propertyType) {
                    ...
                    case SerializedPropertyType.Vector2Int:
                        property.vector2IntValue = VectorUtils.Vector3IntToVector2Int(WrapIntVector(minMaxX, minMaxY,
                    ...
                    case SerializedPropertyType.Vector3Int:
                        property.vector3IntValue =
                            WrapIntVector(minMaxX, minMaxY, minMaxZ, minMaxW, property.vector3IntValue);
        ...
        private Vector4 WrapVector((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,
        ...
        private Rect WrapRect((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,
        ...
        private Vector3Int WrapIntVector((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,
        ...
        private RectInt WrapIntRect((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,
        ...
        private void WrapAxis((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,

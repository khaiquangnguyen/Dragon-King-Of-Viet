            ...
            if (property.propertyType == SerializedPropertyType.Integer ||
                ...
                progressBar.schedule.Execute(() => {
                    if (CanApplyGlobalColor)
                        progressBar.Q(className: "unity-progress-bar__progress").style.backgroundColor =
                ...
                root.Add(new HelpBox("The ProgressBar Attribute can only be attached to an int or float",

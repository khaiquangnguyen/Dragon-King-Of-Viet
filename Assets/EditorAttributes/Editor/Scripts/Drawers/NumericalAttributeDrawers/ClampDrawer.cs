...
namespace EditorAttributes.Editor {
    ...
    public class ClampDrawer : PropertyDrawerBase {
            ...
            root.RegisterCallback<SerializedPropertyChangeEvent>((e) => {
                switch (property.propertyType) {
                    ...
                    case SerializedPropertyType.Vector2Int:
                        property.vector2IntValue = VectorUtils.Vector3IntToVector2Int(ClampIntVector(minMaxX, minMaxY,
                            minMaxZ, minMaxW, new(property.vector2IntValue.x, property.vector2IntValue.y)));
                    ...
                    case SerializedPropertyType.Vector3Int:
                        property.vector3IntValue =
                            ClampIntVector(minMaxX, minMaxY, minMaxZ, minMaxW, property.vector3IntValue);
        ...
        private Vector4 ClampVector((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,
        ...
        private Rect ClampRect((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,
        ...
        private Vector3Int ClampIntVector((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,
            (float, float) minMaxW, Vector3Int vectorValue) {
        ...
        private RectInt ClampIntRect((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,
        ...
        private void ClampAxis((float, float) minMaxX, (float, float) minMaxY, (float, float) minMaxZ,

            ...
            switch (property.propertyType) {
                ...
                case SerializedPropertyType.Generic:
                    ...
                    if (property.serializedObject.targetObject is not Component) {
                        root.Add(new HelpBox("The DrawHandle Attribute can only be used with GameObjects",
                    ...
                    if (drawHandleAttribute.HandleSpace == Space.Self) {
                        if (property.propertyType == SerializedPropertyType.Vector2Int ||
                            ...
                            root.Add(new HelpBox("Vector2Int and Vector3Int handles don't support local space",
                ...
                default:
                    root.Add(new HelpBox(
                        "The DrawHandle Attribute can only be used on int, float, Vector2, Vector2Int, Vector3, Vector3Int, Bounds and SimpleTransform fields",
                        HelpBoxMessageType.Error));
                    break;
            }

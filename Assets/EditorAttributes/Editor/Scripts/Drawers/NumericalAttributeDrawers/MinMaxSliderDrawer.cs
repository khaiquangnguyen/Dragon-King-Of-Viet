    ...
    public class MinMaxSliderDrawer : PropertyDrawerBase {
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            if (property.propertyType == SerializedPropertyType.Vector2 ||
                ...
                var minMaxSlider = new MinMaxSlider(minValue, maxValue, minMaxSliderAttribute.MinRange,
                ...
                if (minMaxSliderAttribute.ShowValues) {
                    var minField = new FloatField(5) {
                        showMixedValue = property.hasMultipleDifferentValues, style = { maxWidth = 50f, minWidth = 50f }
                    };
                    var maxField = new FloatField(5) {
                        showMixedValue = property.hasMultipleDifferentValues, style = { maxWidth = 50f, minWidth = 50f }
                    };
                    ...
                    minField.RegisterValueChangedCallback((callback) => {
                        ...
                        minMaxSlider.value = isIntVector
                            ? new Vector2Int((int)callback.newValue, (int)minMaxSlider.value.y)
                    ...
                    maxField.RegisterValueChangedCallback((callback) => {
                        ...
                        minMaxSlider.value = isIntVector
                            ? new Vector2Int((int)minMaxSlider.value.x, (int)callback.newValue)
                ...
                root.Add(new HelpBox("MinMaxSlider Attribute can only be attached to a Vector2 and Vector2Int",
        ...
        private void ApplyPropertyValues(SerializedProperty property, bool isIntVector, float minValue,
            float maxValue) {
            if (isIntVector) {

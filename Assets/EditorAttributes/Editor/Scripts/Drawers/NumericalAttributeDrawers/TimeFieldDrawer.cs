        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            if (property.propertyType is SerializedPropertyType.Float or SerializedPropertyType.Integer) {
                var timeField = new Vector3Field(property.displayName) {
                    value = new Vector3(EditorPrefs.GetFloat(timeVectorSaveKeyX),
                        EditorPrefs.GetFloat(timeVectorSaveKeyY), EditorPrefs.GetFloat(timeVectorSaveKeyZ))
                };
                ...
                timeField.RegisterValueChangedCallback((callback) => {
                    switch (property.propertyType) {
                        ...
                        case SerializedPropertyType.Integer:
                            property.intValue =
                                Mathf.RoundToInt(GetConvertedTimeValue(callback.newValue, timeFieldAttribute));
                            break;
                    }

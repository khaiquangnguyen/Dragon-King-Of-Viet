    ...
    public class RequiredDrawer : PropertyDrawerBase {
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            if (property.propertyType == SerializedPropertyType.ObjectReference) {
                var helpBox = new HelpBox($"The field <b>{property.displayName}</b> must be assigned",
                ...
                root.Add(new HelpBox("The attached field must derive from <b>UnityEngine.Object</b>",
                    HelpBoxMessageType.Error));
            }

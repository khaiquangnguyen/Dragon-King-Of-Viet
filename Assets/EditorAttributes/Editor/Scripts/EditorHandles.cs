                ...
                try {
                    ...
                    switch (serializedProperty.propertyType) {
                        case SerializedPropertyType.Integer:
                            serializedProperty.intValue = (int)Handles.RadiusHandle(Quaternion.identity,
                                drawHandleAttribute.HandleSpace == Space.World
                                    ? Vector3.zero
                                    : target.transform.position, serializedProperty.intValue);
                            break;

                        case SerializedPropertyType.Float:
                            serializedProperty.floatValue = Handles.RadiusHandle(Quaternion.identity,
                                drawHandleAttribute.HandleSpace == Space.World
                                    ? Vector3.zero
                                    : target.transform.position, serializedProperty.floatValue);
                            break;

                        case SerializedPropertyType.Vector2:
                            var positionVector2 = serializedProperty.vector2Value;
                            var worldPositionVector2 = drawHandleAttribute.HandleSpace == Space.World
                                ? positionVector2
                                : (Vector2)target.transform.TransformPoint(positionVector2);
                            var handlePositionVector2 =
                                Handles.PositionHandle(worldPositionVector2, Quaternion.identity);

                            serializedProperty.vector2Value = drawHandleAttribute.HandleSpace == Space.World
                                ? handlePositionVector2
                                : target.transform.InverseTransformPoint(handlePositionVector2);

                            Handles.Label(VectorUtils.AddVector(worldPositionVector2, labelPostionAdd),
                                serializedProperty.displayName, EditorStyles.boldLabel);
                            break;

                        case SerializedPropertyType.Vector3:
                            var positionVector3 = serializedProperty.vector3Value;
                            var worldPositionVector3 = drawHandleAttribute.HandleSpace == Space.World
                                ? positionVector3
                                : target.transform.TransformPoint(positionVector3);
                            var handlePositionVector3 =
                                Handles.PositionHandle(worldPositionVector3, Quaternion.identity);

                            serializedProperty.vector3Value = drawHandleAttribute.HandleSpace == Space.World
                                ? handlePositionVector3
                                : target.transform.InverseTransformPoint(handlePositionVector3);

                            Handles.Label(VectorUtils.AddVector(worldPositionVector3, labelPostionAdd),
                                serializedProperty.displayName, EditorStyles.boldLabel);
                            break;
                        ...
                        case SerializedPropertyType.Vector2Int:
                            ...
                            Handles.Label(
                                VectorUtils.AddVector(VectorUtils.Vector2IntToVector2(positionVector2Int),
                                    labelPostionAdd), serializedProperty.displayName, EditorStyles.boldLabel);
                            break;
                        ...
                        case SerializedPropertyType.Vector3Int:
                            ...
                            Handles.Label(VectorUtils.AddVector(positionVector3Int, labelPostionAdd),
                                serializedProperty.displayName, EditorStyles.boldLabel);
                            break;
                        ...
                        case SerializedPropertyType.Bounds:
                            ...
                            boundsHandleList.TryGetValue(serializedProperty.propertyPath,
                                out BoxBoundsHandle boundsHandle);

                            var targetPosition = target.transform.position;
                            var targetRotation = target.transform.rotation;

                            boundsHandle.center = drawHandleAttribute.HandleSpace == Space.World
                                ? boundsValue.center
                                : target.transform.TransformPoint(boundsValue.center);
                            ...
                            serializedProperty.boundsValue =
                                new Bounds(
                                    drawHandleAttribute.HandleSpace == Space.World
                                        ? boundsHandle.center
                                        : target.transform.InverseTransformPoint(boundsHandle.center),
                                    boundsHandle.size);
                            break;
                        ...
                        case SerializedPropertyType.Generic: // SimpleTransform type
                            ...
                            var positionValue = drawHandleAttribute.HandleSpace == Space.World
                                ? transformValue.position
                                : target.transform.TransformPoint(transformValue.position);
                            var rotationValue = drawHandleAttribute.HandleSpace == Space.World
                                ? transformValue.QuaternionRotation
                                : Quaternion.Inverse(transformValue.QuaternionRotation);

                            Handles.TransformHandle(ref positionValue, ref rotationValue, ref transformValue.scale);

                            transformValue.position = drawHandleAttribute.HandleSpace == Space.World
                                ? positionValue
                                : target.transform.InverseTransformPoint(positionValue);
                            transformValue.rotation = drawHandleAttribute.HandleSpace == Space.World
                                ? rotationValue.eulerAngles
                                : Quaternion.Inverse(rotationValue).eulerAngles;

                            Handles.Label(VectorUtils.AddVector(positionValue, labelPostionAdd),
                                serializedProperty.displayName, EditorStyles.boldLabel);

...
namespace EditorAttributes.Editor.Utility {
    public static class ReflectionUtility {
        ...
        internal static MethodInfo FindFunction(string functionName, object targetObject) {
            try {
                return FindMember(functionName, targetObject.GetType(), BINDING_FLAGS,
                    MemberTypes.Method) as MethodInfo;
            }
            catch (AmbiguousMatchException) {
            ...
            switch (memberType) {
                ...
                case MemberTypes.Property:
                    ...
                    while (targetType != null &&
                           !TryGetProperty(memberName, targetType, bindingFlags, out propertyInfo))
                        targetType = targetType.BaseType;
        ...
        public static bool TryGetField(string name, Type targetType, BindingFlags bindingFlags,
        ...
        internal static MemberInfo
            GetValidMemberInfo(string memberName, object targetObject) // Internal function used for the button drawer
        {
            MemberInfo memberInfo;
        ...
        public static object GetMemberInfoValue(MemberInfo memberInfo, SerializedProperty property) {
            ...
            try {
                ...
                if (exception is ArgumentException
                    or TargetException) // If these expections are thrown it means that the member we try to get the value from is inside a different target
                {
        ...
        internal static object
            GetMemberInfoValue(MemberInfo memberInfo,
                object targetObject) // Internal function used for the button drawer
        {
            if (targetObject == null)
                return null;

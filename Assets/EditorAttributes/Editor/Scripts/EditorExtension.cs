...
namespace EditorAttributes.Editor {
    ...
    public class EditorExtension : UnityEditor.Editor {
        ...
        protected VisualElement DrawStaticFields() {
            var root = new VisualElement();
            var staticFields = target.GetType()
            ...
            foreach (var staticField in staticFields) {
                ...
                var propertyField = ButtonDrawer.DrawParameterField(staticField.FieldType,
                    ObjectNames.NicifyVariableName(staticField.Name), staticField.GetValue(target));

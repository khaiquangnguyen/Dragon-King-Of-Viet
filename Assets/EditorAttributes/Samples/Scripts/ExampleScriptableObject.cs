...
namespace EditorAttributesSamples {
    ...
    public class ExampleScriptableObject : ScriptableObject {
        ...
        [MinMaxSlider(0, 100)]
        public Vector2Int startingCurrency;
        ...
        [Suffix(nameof(GetTimeOfDay), stringInputMode: StringInputMode.Dynamic),
         TimeField(TimeFormat.HourMinuteSecond, ConvertTo.Minutes)]
        public float timeOfDay;
        [Space]
        [Dropdown(nameof(GetAudioClips))]
        public string backgroundMusic;
        [AssetPreview]
        public Sprite levelBackground;

        private string[] GetAudioClips() => new string[]
            { "Music/BackgroundMusic1", "Music/BackgroundMusic2", "SFX/Explosion" };

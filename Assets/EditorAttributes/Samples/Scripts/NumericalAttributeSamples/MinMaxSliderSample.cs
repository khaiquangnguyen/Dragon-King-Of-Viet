...
namespace EditorAttributesSamples {
    ...
    public class MinMaxSliderSample : MonoBehaviour {
        ...
        private Vector2Int vector2IntField;
        [Space]
        [SerializeField, MinMaxSlider(0f, 10f, false)]
        private Vector2 vector2FieldNoField;
        [SerializeField, MinMaxSlider(0f, 10f, false)]
        private Vector2Int vector2IntFieldNoField;
    }
}
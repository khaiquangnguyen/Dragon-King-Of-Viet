...
namespace EditorAttributesSamples {
    [HelpURL(
        "https://editorattributesdocs.readthedocs.io/en/latest/Attributes/ConditionalAttributes/conditionalfield.html")]
    public class ConditionalFieldSample : MonoBehaviour {
        ...
        [SerializeField]
        private int _conditionalFieldAND;

        [ConditionalField(ConditionType.OR, ConditionResult.EnableDisable, nameof(_condition01), nameof(_condition02))]
        [SerializeField]
        private int _conditionalFieldOR;

        [ConditionalField(ConditionType.NAND, ConditionResult.EnableDisable, nameof(_condition01),
            nameof(_condition02))]
        [SerializeField]
        private int _conditionalFieldNAND;

        [ConditionalField(ConditionType.NOR, ConditionResult.EnableDisable, nameof(_condition01), nameof(_condition02))]
        [SerializeField]
        private int _conditionalFieldNOR;

        [ConditionalField(ConditionType.AND, ConditionResult.EnableDisable, new bool[] { false, true },
            nameof(_condition01), nameof(_condition02))]
        [SerializeField]
        private int _conditionalFieldANDNegated;
    }
}
...
namespace EditorAttributesSamples {
    ...
    public class MessageBoxSample : MonoBehaviour {
        ...
        [SerializeField]
        private string dynamicMessageBox;

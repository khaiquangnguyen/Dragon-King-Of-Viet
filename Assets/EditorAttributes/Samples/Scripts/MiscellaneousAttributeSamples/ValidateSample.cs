...
namespace EditorAttributesSamples {
    ...
    public class ValidateSample : MonoBehaviour {
        ...
        [SerializeField, Validate("The field must be above zero", nameof(MustBeAboveZero))]
        private int intField;
        [SerializeField, Validate("String can't be empty", nameof(CantBeEmpty), MessageMode.Warning)]

...
namespace EditorAttributes {
    ...
    public class ButtonAttribute : PropertyAttribute, IConditionalAttribute, IRepetableButton {
        ...
        /// <param name="buttonHeight">The height of the button in pixels</param>
        /// <param name="serializeParameters">Have the button parameters persist between selections</param>
        public ButtonAttribute(bool isRepetable, long pressDelay = 60, long repetitionInterval = 100,
            string buttonLabel = "", float buttonHeight = 18f, bool serializeParameters = true)
        ...
        /// <param name="buttonHeight">The height of the button in pixels</param>
        /// <param name="serializeParameters">Have the button parameters persist between selections</param>
        public ButtonAttribute(string conditionName, ConditionResult conditionResult, bool negate = false,
            string buttonLabel = "", float buttonHeight = 18f, bool serializeParameters = true)
            : this(buttonLabel, buttonHeight, serializeParameters) {
        ...
        /// <param name="buttonHeight">The height of the button in pixels</param>
        /// <param name="serializeParameters">Have the button parameters persist between selections</param>
        public ButtonAttribute(bool isRepetable, string conditionName, ConditionResult conditionResult,
            bool negate = false, long pressDelay = 60, long repetitionInterval = 100, string buttonLabel = "",
            float buttonHeight = 18f, bool serializeParameters = true)
        ...
        /// <param name="buttonHeight">The height of the button in pixels</param>
        /// <param name="serializeParameters">Have the button parameters persist between selections</param>
        public ButtonAttribute(string conditionName, object enumValue, ConditionResult conditionResult,
            bool negate = false, string buttonLabel = "", float buttonHeight = 18f, bool serializeParameters = true)
            : this(conditionName, conditionResult, negate, buttonLabel, buttonHeight, serializeParameters) =>
        ...
        /// <param name="buttonHeight">The height of the button in pixels</param>
        /// <param name="serializeParameters">Have the button parameters persist between selections</param>
        public ButtonAttribute(bool isRepetable, string conditionName, object enumValue,
            ConditionResult conditionResult, bool negate = false, long pressDelay = 60, long repetitionInterval = 100,
            string buttonLabel = "", float buttonHeight = 18f, bool serializeParameters = true)
            : this(isRepetable, conditionName, conditionResult, negate, pressDelay, repetitionInterval, buttonLabel,
                buttonHeight, serializeParameters) => EnumValue = (int)enumValue;
    }
}
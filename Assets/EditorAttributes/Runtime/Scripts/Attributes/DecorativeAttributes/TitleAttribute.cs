...
namespace EditorAttributes {
    public class TitleAttribute : PropertyAttribute, IDynamicStringAttribute {
        ...
        public TitleAttribute(string title, int titleSize = 20, float titleSpace = 10f, bool drawLine = true,
            float lineThickness = 2f, TextAnchor alignment = TextAnchor.MiddleLeft,

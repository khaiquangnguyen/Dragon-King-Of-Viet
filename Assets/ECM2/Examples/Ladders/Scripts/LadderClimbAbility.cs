...
namespace ECM2.Examples.Ladders {
    ...
    public class LadderClimbAbility : MonoBehaviour {
        ...
        public bool IsClimbing() {
            var isClimbing = _character.movementMode == Character.MovementMode.Custom &&
        ...
        private bool CanClimb() {
            ...
            var characterMovement = _character.characterMovement;
            var overlappedColliders =
                characterMovement.OverlapTest(ladderMask, QueryTriggerInteraction.Collide, out var overlapCount);
            ...
            switch (_climbingState) {
                ...
                case ClimbingState.Releasing: {
                    ...
                    if (_ladderTime <= grabbingTime) {
                        var interpolatedPosition = Vector3.Lerp(_ladderStartPosition, _ladderTargetPosition,
                ...
                case ClimbingState.Grabbed: {
                    ...
                    if (Mathf.Abs(_ladderPathPosition) < 0.05f) {
                        ...
                        var movementInput = _character.GetMovementDirection();
        ...
        private void OnMovementModeChanged(Character.MovementMode prevMovementMode, int prevCustomMovementMode) {
            ...
            var wasClimbing = prevMovementMode == Character.MovementMode.Custom &&
        ...
        private void OnCustomRotationModeUpdated(float deltaTime) {
            if (IsClimbing() &&
                (_climbingState == ClimbingState.Grabbing || _climbingState == ClimbingState.Releasing)) {
                var rotation =

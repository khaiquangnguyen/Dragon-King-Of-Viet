...
namespace ECM2.Examples.Slide {
    ...
    public class PlayerCharacter : Character {
        ...
        protected virtual bool CanSlide() {
            ...
            var slideSpeedThreshold = maxWalkSpeedCrouched * maxWalkSpeedCrouched;
        ...
        protected virtual Vector3 CalcSlideDirection() {
            var slideDirection = GetMovementDirection();
        ...
        protected virtual void CheckSlideInput() {
            ...
            var wantsToSlide = crouchInputPressed;

            if (!isSliding && wantsToSlide && CanSlide())
                SetMovementMode(MovementMode.Custom, (int)ECustomMovementMode.Sliding);
            else if (isSliding && (!wantsToSlide || !CanSlide())) SetMovementMode(MovementMode.Walking);
        }
        ...
        protected override void OnMovementModeChanged(MovementMode prevMovementMode, int prevCustomMode) {
            ...
            if (IsSliding()) {
                ...
                var slideDirection = CalcSlideDirection();
            ...
            var wasSliding = prevMovementMode == MovementMode.Custom &&
            ...
            if (wasSliding) {
                ...
                if (IsFalling()) {
                    ...
                    var verticalVelocity = Vector3.Project(velocity, worldUp);
                    var lateralVelocity = Vector3.ClampMagnitude(velocity - verticalVelocity, maxWalkSpeed);
        ...
        protected virtual void SlidingMovementMode(float deltaTime) {
            ...
            var desiredVelocity = Vector3.Project(GetDesiredVelocity(), GetRightVector());

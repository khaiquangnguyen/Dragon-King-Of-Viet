...
namespace ECM2.Examples.PlanetWalk {
    ...
    public class PlayerCharacter : Character {
        ...
        protected override void UpdateRotation(float deltaTime) {
            ...
            var toPlanet = planetTransform.position - GetPosition();
            ...
            var worldUp = GetGravityDirection() * -1.0f;
            var newRotation = Quaternion.FromToRotation(GetUpVector(), worldUp) * GetRotation();

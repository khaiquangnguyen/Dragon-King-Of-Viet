        ...
        private void OnTriggerEnter(Collider other) {
            ...
            if (other.TryGetComponent(out Character character)) {
                ...
                if (OrientWithDestination) {
                    ...
                    var teleporterForward = destination.transform.forward.projectedOnPlane(characterUp);

                    var newRotation = Quaternion.LookRotation(teleporterForward, character.GetUpVector());

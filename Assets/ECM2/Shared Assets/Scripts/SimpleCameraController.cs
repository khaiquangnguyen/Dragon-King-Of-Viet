...
namespace ECM2.Examples {
    public sealed class SimpleCameraController : MonoBehaviour {
        ...
        public void LateUpdate() {
            ...
            var targetPosition = target.position - transform.forward * distanceToTarget;
            transform.position =
                Vector3.SmoothDamp(transform.position, targetPosition, ref _followVelocity, _smoothTime);
        }
        #endregion
    }
}
...
namespace ECM2.Walkthrough.Ex92 {
    ...
    public class ThirdPersonController : MonoBehaviour {
        ...
        public Vector2 lookSensitivity = new(1.5f, 1.25f);
        ...
        private void UpdateCamera() {
            ...
            _cmThirdPersonFollow.CameraDistance =
                Mathf.SmoothDamp(_cmThirdPersonFollow.CameraDistance, followDistance, ref _followDistanceSmoothVelocity,
                    0.1f);
        }
        ...
        private void Update() {
            ...
            var mouseScrollInput = Input.GetAxisRaw("Mouse ScrollWheel");

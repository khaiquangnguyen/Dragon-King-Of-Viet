...
namespace ECM2 {
    ...
    public class Character : MonoBehaviour {
        ...
        #region FIELDS
        protected readonly List<PhysicsVolume> _physicsVolumes = new();
        ...
        public void TeleportPosition(Vector3 newPosition, bool interpolating = true, bool updateGround = false) {
            if (interpolating) characterMovement.interpolation = RigidbodyInterpolation.None;

            characterMovement.SetPosition(newPosition, updateGround);

            if (interpolating) characterMovement.interpolation = RigidbodyInterpolation.Interpolate;
        }
        ...
        public virtual float GetMaxJumpHeight() {
            ...
            if (gravityMagnitude > 0.0001f) return jumpImpulse * jumpImpulse / (2.0f * gravityMagnitude);
        ...
        protected virtual void Start() {
            ...
            if (_startingMovementMode == MovementMode.Walking) characterMovement.SetPosition(transform.position, true);
        }

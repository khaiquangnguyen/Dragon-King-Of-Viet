...
namespace ECM2 {
    public static class Extensions {
        ...
        public static Vector3 tangentTo(this Vector3 thisVector, Vector3 normal, Vector3 up) {
            var r = thisVector.perpendicularTo(up);
            var t = normal.perpendicularTo(r);
        ...
        public static Vector3 relativeTo(this Vector3 vector3, Transform relativeToThis, bool isPlanar = true) {
            var forward = relativeToThis.forward;
        ...
        public static Vector3 relativeTo(this Vector3 vector3, Transform relativeToThis, Vector3 upAxis,
            ...
            var q = Quaternion.LookRotation(forward, upAxis);
        ...
        public static Quaternion clampPitch(this Quaternion quaternion, float minPitchAngle, float maxPitchAngle) {
            ...
            var pitch = Mathf.Clamp(2.0f * Mathf.Rad2Deg * Mathf.Atan(quaternion.x), minPitchAngle, maxPitchAngle);
